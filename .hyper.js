...
module.exports = {
  config: {
    ...
    fontFamily: '"SF Mono", "IBM Plex Mono", "Anonymous Pro", "Inconsolata", monospace',
    ...
    QingTheme: {
      ...
      // NOTE: The backgroundOpacity should be between 0.1 and 0.9 to see the
      // effect.
      vibrancy: 'dark'
    },
    ...
    MaterialTheme: {
      ...
      // [Optional] Set the rgba() app background opacity, useful when
      // enableVibrance is true
      // OPTIONS: From 0.1 to 1
      backgroundOpacity: '.8',
      ...
      // background OPTIONS: 'dark', 'ultra-dark', 'bright'
      // NOTE: The backgroundOpacity should be between 0.1 and 0.9 to see the
      // effect.
      vibrancy: 'dark',
    },
  ...
  localPlugins: [
    //'hyper-native-vibrant'
    //'hyper-vibrant'
    //'hyper-material-light'
    //'hyper-frosty'
    //'hyper-light'

    //'hyper-one-light-vibrant'
    'hyper-qing'
  ],
